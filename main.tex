...
\newcommand{\unit}[1]{%
    ...
    {\large \textit{Mathematical Knowledge Framework}}\\[10pt]%
...
Thirdly, I want to thank my friends. Their belief in me has helped fuel Elder Theory into inception.
...
% Moved to Part II: \input{chapters/part1_theory/core_concepts/concrete_example.tex}
...
\input{chapters/part1_theory/functions_and_geometry/formula_elaborations.tex} % Detailed mathematical formula breakdowns and visual elaborations
...
\input{chapters/part1_theory/mechanics_and_dynamics/knowledge_theory_elaborations.tex} % Knowledge externalization, curriculum generation, and gap identification
\input{chapters/part1_theory/mechanics_and_dynamics/syzygy_mathematical_foundations.tex} % Mathematical foundations of syzygy in heliosystem context
...
%%% UNIT III. PERFORMANCE EVALUATION %%%
...
\input{chapters/appendix/citation_validation.tex}
