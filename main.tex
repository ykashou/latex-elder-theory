...
\usepackage{booktabs}
\usepackage{enumitem}
% Fix deeply nested structures causing margin shift in Unit V onwards
\setlistdepth{6}
...
% Reset margins to prevent shifting from nested structures
...
% Define the unit command - FIXED to prevent margin shift issues
\newcommand{\unit}[1]{%
    \refstepcounter{unit}%
    \cleardoublepage%
    \thispagestyle{empty}%
    % Reset all margins and indentation to prevent nesting issues
