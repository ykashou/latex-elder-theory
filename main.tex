...
% Add to TOC as a unit without numbering (between part and section levels)
\phantomsection % Ensure proper link anchoring
\addtocontents{toc}{\protect\contentsline{part}{Unit IV: Loss Functions by Component}{}{}}
\begin{center}
\Large\bfseries Unit IV: Loss Functions by Component
\end{center}
\vspace{1em}
...
% Add to TOC as a unit without numbering (between part and section levels)
\phantomsection % Ensure proper link anchoring
\addtocontents{toc}{\protect\contentsline{part}{Unit V: Complete Algorithm}{}{}}
\begin{center}
\Large\bfseries Unit V: Complete Algorithm
\end{center}
\vspace{1em}
...
% Add to TOC as a unit without numbering (between part and section levels)
\phantomsection % Ensure proper link anchoring
\addtocontents{toc}{\protect\contentsline{part}{Unit VI: The Elder Heliosystem as a Unified Closed System}{}{}}
\begin{center}
\Large\bfseries Unit VI: The Elder Heliosystem as a Unified Closed System
\end{center}
\vspace{1em}
...
% Add to TOC as a unit without numbering (between part and section levels)
\phantomsection % Ensure proper link anchoring
\addtocontents{toc}{\protect\contentsline{part}{Unit VII: Domain Applications}{}{}}
\begin{center}
...
\input{chapters/part1_theory/memory_and_efficiency/reverse_encodable_data.tex} % Reverse-Encodable Data via Orbital Mechanics

\part{Experiment}

%%% VIII. EXPERIMENTAL SETUP AND METHODOLOGY %%%
% Add to TOC as a unit without numbering (between part and section levels)
\phantomsection % Ensure proper link anchoring
\addtocontents{toc}{\protect\contentsline{part}{Unit VIII: Experimental Setup and Methodology}{}{}}
\begin{center}
...
% Add to TOC as a unit without numbering (between part and section levels)
\phantomsection % Ensure proper link anchoring
\addtocontents{toc}{\protect\contentsline{part}{Unit IX: Performance Evaluation}{}{}}
\begin{center}
