...
% Create a command to automatically add equations to the list
\let\oldequation\equation
\let\endoldequation\endequation
\renewenvironment{equation}
  {\oldequation}
  {\endoldequation\myequations{}}

% For equation arrays and other math environments
\let\oldeqnarray\eqnarray
\let\endoldeqnarray\endeqnarray
\renewenvironment{eqnarray}
  {\oldeqnarray}
  {\endoldeqnarray\myequations{}}

% Command to manually add equations with descriptions
\newcommand{\addequation}[1]{\myequations{#1}}
