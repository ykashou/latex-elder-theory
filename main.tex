...
%%% I. FOUNDATION LAYER %%%
% Add to TOC without numbering
\addcontentsline{toc}{section}{I. Foundation Layer}
...
% Add to TOC without numbering
\addcontentsline{toc}{section}{II. Core Mathematical Framework}
...
% Add to TOC without numbering
\addcontentsline{toc}{section}{III. Hierarchical Learning Structure}
...
% Add to TOC without numbering
\addcontentsline{toc}{section}{IV. Loss Functions by Component}
...
% Add to TOC without numbering
\addcontentsline{toc}{section}{V. Complete Algorithm}
...
% Add to TOC without numbering
\addcontentsline{toc}{section}{VI. The Elder Heliosystem as a Unified Closed System}
...
% Add to TOC without numbering
\addcontentsline{toc}{section}{VII. Domain Applications}
...
% Add to TOC without numbering
\addcontentsline{toc}{section}{VIII. Experimental Setup and Methodology}
\section*{VIII. Experimental Setup and Methodology}
\input{chapters/part2_experiment/experiment.tex}

%%% IX. PERFORMANCE EVALUATION %%%
% Add to TOC without numbering
\addcontentsline{toc}{section}{IX. Performance Evaluation}
