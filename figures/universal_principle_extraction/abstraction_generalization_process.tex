...
\begin{tikzpicture}[scale=0.85, transform shape]
    % Define styles
    \tikzstyle{invariant} = [draw, fill=red!20, rounded corners, minimum width=3cm, minimum height=1cm, align=center]
    \tikzstyle{principle} = [draw, fill=violet!20, rounded corners, minimum width=3cm, minimum height=1cm, text width=2.8cm, align=center]
    \tikzstyle{generalized} = [draw, fill=teal!20, rounded corners, minimum width=4cm, minimum height=1.2cm, text width=3.8cm, align=center]
    \tikzstyle{arrow} = [->, >=latex, thick]
    \tikzstyle{process} = [draw, dashed, fill=green!10, rounded corners, minimum width=3.5cm, minimum height=1.5cm, text width=3.3cm, align=center]
