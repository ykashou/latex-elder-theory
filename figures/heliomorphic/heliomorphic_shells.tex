\begin{tikzpicture}[scale=1.1]
  ...
  \foreach \r in {0.5,1.0,1.5,2.0,2.5,3.0,3.5}
    \draw[elderborder!30, dashed, very thin] (0,0) circle (\r);
  ...
  \node[align=left, font=\small] at (5.9,0.6) {Elder Field Region};
  \shade[inner color=elderfield, outer color=mentorfield] (4,0.1) rectangle (4.3,0.3);
  \node[align=left, font=\small] at (6.0,0.2) {Mentor Field Region};
  \shade[inner color=mentorfield, outer color=eruditefield] (4,-0.3) rectangle (4.3,-0.1);
  \node[align=left, font=\small] at (6.0,-0.2) {Erudite Field Region};
  
  % Field radius markers
  \node[font=\small] at (1.5,0.4) {Radius 1.5};
  \node[font=\small] at (2.5,0.4) {Radius 2.5};
  \node[font=\small] at (3.5,0.4) {Radius 3.5};
\end{tikzpicture}