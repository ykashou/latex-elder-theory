...
\begin{scope}[shift={(8, 0)}]
    ...
    \foreach \x in {-2, -1.5, ..., 2} {
        \foreach \y in {-2, -1.5, ..., 2} {
            ...
            \pgfmathsetmacro{\dist1}{sqrt((\x + 1.5)^2 + \y^2)}
            \pgfmathsetmacro{\dist2}{sqrt(\x^2 + \y^2)}
            \pgfmathsetmacro{\dist3}{sqrt((\x - 1.5)^2 + \y^2)}
            
            \pgfmathsetmacro{\field1}{0.5 * \dist1^2}
            \pgfmathsetmacro{\field2}{1.0 * \dist2^2}
            \pgfmathsetmacro{\field3}{1.5 * \dist3^2}
            
            \pgfmathsetmacro{\totalfield}{\field1 + \field2 + \field3}
            \pgfmathsetmacro{\intensity}{min(\totalfield / 10, 1)}
