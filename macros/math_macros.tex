...
\providecommand{\elderentity}{\mathfrak{E}} % Elder entity (Gothic E)
\providecommand{\mentorentity}{\mathfrak{M}} % Mentor entity (Gothic M)
\providecommand{\eruditeentity}{\mathfrak{E}r} % Erudite entity (Gothic Er)
