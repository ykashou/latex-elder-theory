...
% ANNOTATION 25: More rigorous mathematical symbols for Elder entities (redefined from calligraphic to Gothic)
\renewcommand{\elderentity}{\mathfrak{E}} % Elder entity (Gothic E)
\renewcommand{\mentorentity}{\mathfrak{M}} % Mentor entity (Gothic M)
\renewcommand{\eruditeentity}{\mathfrak{E}r} % Erudite entity (Gothic Er)
