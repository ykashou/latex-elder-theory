...
\hline
Elder $\rightarrow$ Mentor & $T_{E \rightarrow M} = 2\pi/\omega_E$ & $\gamma_{EM} = 0.3$ & $0.6\pi/\omega_E$ \\
Mentor $\rightarrow$ Erudite & $T_{M \rightarrow Er} = 2\pi/\omega_M$ & $\gamma_{M Er} = 0.4$ & $0.8\pi/\omega_M$ \\
Elder $\rightarrow$ Erudite (Direct) & $T_{E \rightarrow Er} = 4\pi/\omega_E$ & $\gamma_{E Er} = 0.1$ & $3.6\pi/\omega_E$ \\
Erudite $\rightarrow$ Mentor (Feedback) & $T_{Er \rightarrow M} = \pi/\omega_{Er}$ & $\gamma_{Er M} = 0.8$ & $0.2\pi/\omega_{Er}$ \\
\hline
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item Lower $\eta$ $\rightarrow$ slower learning but higher $P_{\text{stability}}$
    \item Higher $\eta$ $\rightarrow$ faster learning but potential instability
\end{itemize}
...
\hline
Elder $\rightarrow$ Mentor & 2.3 ± 0.2 & 0.8 ± 0.1 & 2.9× \\
Mentor $\rightarrow$ Erudite & 1.7 ± 0.3 & 0.5 ± 0.1 & 3.4× \\
Elder $\rightarrow$ Erudite (Direct) & 8.2 ± 1.1 & 2.1 ± 0.3 & 3.9× \\
Erudite $\leftrightarrow$ Erudite & 3.4 ± 0.5 & 1.2 ± 0.2 & 2.8× \\
