...
\Function{HeliomorphicManifoldDiscovery}{$\{\mathcal{D}_i\}_{i=1}^M$, $\{\theta_{\text{M},i}\}_{i=1}^M$}
    ...
    \For{$t = 1$ to $T$}
        ...
        \State // Enforce gravitational field structure through radial structure reorganization
        \State // Structure reorganization ensures optimal knowledge flow patterns
