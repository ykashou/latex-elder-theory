...
\begin{tikzpicture}[scale=1.0]
    % Background grid
    \draw[gray!30, thin] (-4,-3) grid (4,3);
    
    % Resonance basin 1 (left)
    \filldraw[blue!20, thick, blue] (-3,1) ellipse (0.8 and 1.2);
    \node[blue, font=\small] at (-3,1) {Basin 1};
    
    % Resonance basin 2 (center)
    \filldraw[red!20, thick, red] (0,-0.5) ellipse (1.2 and 0.8);
    \node[red, font=\small] at (0,-0.5) {Basin 2};
    
    % Resonance basin 3 (right)
    \filldraw[green!20, thick, green] (2.5,1.5) ellipse (1.0 and 1.0);
    \node[green, font=\small] at (2.5,1.5) {Basin 3};
    
    % Gradient flow arrows into basins
    \draw[->, thick, blue!70] (-4,2) to[out=0,in=120] (-3,1);
    \draw[->, thick, blue!70] (-2,2.5) to[out=250,in=60] (-3,1);
    \draw[->, thick, red!70] (-1.5,-2) to[out=45,in=220] (0,-0.5);
    \draw[->, thick, red!70] (1.5,-1.8) to[out=135,in=320] (0,-0.5);
    \draw[->, thick, green!70] (4,0.5) to[out=180,in=30] (2.5,1.5);
    \draw[->, thick, green!70] (3.5,3) to[out=210,in=90] (2.5,1.5);
    
    % Phase coherence contours
    \draw[dashed, purple] (-3,1) circle (1.5);
    \draw[dashed, purple] (0,-0.5) circle (1.8);
    \draw[dashed, purple] (2.5,1.5) circle (1.7);
    
    % Labels
    \node at (-4,-2.5) {$\theta_1$};
    \node at (0,-2.5) {$\theta_2$};
    \node at (4,-2.5) {$\theta_3$};
    \node[purple] at (-4,0) {Phase};
    \node[purple] at (-4,-0.3) {coherence};
    
    % Coordinate axes
    \draw[->, thick] (-4.5,0) -- (4.5,0);
    \draw[->, thick] (0,-3.5) -- (0,3.5);
    \node at (4.7,0) {$\theta_{\text{real}}$};
    \node at (0,3.7) {$\theta_{\text{imag}}$};
\end{tikzpicture}
\caption{Resonance basins in the Elder gradient landscape. Each colored region represents a basin where parameters maintain specific phase relationships. Gradient flows (arrows) naturally converge into these basins, while dashed circles show phase coherence boundaries.}
