...
\hline
\end{tabular}
\captionof{table}{Comparison between traditional learning theory and Elder theory.}
...
\hline
\end{tabular}
\captionof{table}{Comparison between complex analysis and heliomorphic analysis from Elder theory.}
...
\hline
\end{tabular}
\captionof{table}{Comparison between classical dynamical systems theory and Elder dynamical systems.}
...
\hline
\end{tabular}
\captionof{table}{Quantitative comparison of mathematical advantages of Elder theory over traditional approaches.}
