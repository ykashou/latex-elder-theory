...
% Primary domain orbits
\draw[dashed] (0,0) circle (2);
\draw[dashed] (0,0) circle (4);

% Primary Mentors (inner orbit)
\filldraw[blue] (0,2) circle (0.25) node[above] {Audio};
\filldraw[blue] (1.9,0.62) circle (0.25) node[right] {Visual};
\filldraw[blue] (1.17,-1.62) circle (0.25) node[below right] {Semantic};
\filldraw[blue] (-1.17,-1.62) circle (0.25) node[below left] {Temporal};
\filldraw[blue] (-1.9,0.62) circle (0.25) node[left] {Spatial};

% Secondary Mentors (selected)
\filldraw[cyan] (0,4) circle (0.2) node[above] {Harmonics};
\filldraw[cyan] (3.8,1.24) circle (0.2) node[right] {Object Recognition};
\filldraw[cyan] (-3.8,1.24) circle (0.2) node[left] {Room Acoustics};

% Erudites (selected)
\filldraw[green!60!black] (0,4.6) circle (0.15);
\filldraw[green!60!black] (0.3,4.5) circle (0.15);
\filldraw[green!60!black] (-0.3,4.5) circle (0.15);
\filldraw[green!60!black] (4.3,1.4) circle (0.15);
\filldraw[green!60!black] (4.4,1.0) circle (0.15);

% Labeled orbits
\node at (3,0) {Primary Domain Orbit};
\node at (5,0) {Secondary Domain Orbit};

% Cross-modal connections
\draw[dotted, ->] (0,2) to[bend right=15] (1.9,0.62);
\draw[dotted, ->] (1.9,0.62) to[bend right=15] (1.17,-1.62);
\draw[dotted, ->] (1.17,-1.62) to[bend right=15] (-1.17,-1.62);
\draw[dotted, ->] (-1.17,-1.62) to[bend right=15] (-1.9,0.62);
\draw[dotted, ->] (-1.9,0.62) to[bend right=15] (0,2);
...
\For{each time step $t$}
    ...
    \For{each Primary Domain Mentor $M_i$}
