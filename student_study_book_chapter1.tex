...
\input{workbooks/chapter1/part1_foundations.tex}

% ==================== PART II: TECHNIQUES ====================
\part{Techniques: Computational Methods}

\input{workbooks/chapter1/part2_techniques.tex}

% ==================== PART III: ADVANCED TOPICS ====================
\part{Advanced Topics: Dynamics and Complexity}

\input{workbooks/chapter1/part3_advanced.tex}

% ==================== PART IV: SYNTHESIS AND MASTERY ====================
\part{Synthesis and Mastery}

\input{workbooks/chapter1/part4_mastery.tex}
...
\input{workbooks/chapter1/appendix_formulas.tex}
\input{workbooks/chapter1/appendix_mistakes.tex}
\input{workbooks/chapter1/appendix_solutions.tex}
